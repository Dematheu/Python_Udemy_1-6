    ...
    def opcoes(self):
        ...
        if opc == 1:
            ...
            if self.__dias_sem_comer <= 3:
                ...
                try:
                    arquivo = open('_tamagotchi.txt', 'w+')
                    arquivo.close()
            ...
            with open('_tamagotchi.txt', 'w+') as arquivo:
...
# Main Program
try:
    with open('_tamagotchi.txt', 'r') as file:
        if len(file.readlines()) != 0:
            ...
            print(f'Tamagotchi {tamagotchi.nome} carregado com sucesso!')
        else:
